...
def _persona_rationale(persona: str, ticker: str, verdict: str, settings: dict) -> str:
    ...
    base = {
        "warren_buffett": {
            ...
            "BAM":   "ברוקפילד מנהלת מעל $900B בנכסים אלטרנטיביים (תשתיות, נדל״ן, אנרגיה מתחדשת, פרייבט אקוויטי) — חפיר תחרותי בהפצה ובגודל. מודל ההכנסות משילוב דמי ניהול ועמלות הצלחה יציב לאורך מחזורים. דיבידנד צומח באופן עקבי — עסק איכותי לטווח ארוך.",
            ...
            "5108.TA": "קרן הביטוח הישראלית מחזיקה בחברות הביטוח הגדולות — רווחיות יציבה, דיבידנדים קבועים, יחס Solvency II תקין. חשיפה מקומית שקלית הגנתית, מפחיתה סיכון מט״ח. מתאימה לפרופיל שמרן.",
        },
        "charlie_munger": {
            ...
            "BAM":   "בראם פלאטט (המנכ״ל) הוא אחד המנהלים הטובים בתחום הנכסים האלטרנטיביים. זו הדוגמא הקלאסית של 'עסק איכותי במחיר הוגן' — חפיר בהפצה, אנשים חכמים, תמחור סביר.",
            ...
            "5108.TA": "סקטור הביטוח הישראלי — שקט, יציב, משלם דיבידנדים. אני לא מבין בכלכלה הישראלית, אבל העקרונות נראים בריאים.",
        },
        "cathie_wood": {
            ...
            "BAM":   "תשתיות ואנרגיה מתחדשת תומכות בתזת החדשנות — BAM חשופה לזה דרך Brookfield Renewable.",
            ...
            "5108.TA": "ביטוח לא במוקד התזה שלי.",
        },
        "peter_lynch": {
            ...
            "BAM":   "צמיחת AUM של 15%+ שנתית, דיבידנד צומח של 10%+ — סיפור 'מצטבר' קלאסי. לא מרגש, אבל עם הריבית המצטברת מעל 10 שנים זה ירוויח יותר מרוב המניות.",
            ...
            "5108.TA": "אני לא מכיר את השוק הישראלי. אם אמית מאמין, שיחזיק — אבל אני לא יכול להמליץ ממרחק.",
        },
        "technical_analyst": {
            ...
            "BAM":   "מגמה עולה לאורך שנה שלמה. ירידות קטנות נתמכות בעקביות ע״י MA50. התבנית היא 'מדרגות עולות' קלאסית.",
            ...
            "5108.TA": "מגמה עולה ארוכת-טווח, תנודתיות נמוכה מאוד. ללא איתות שינוי. המשך החזקה.",
            "AMZN_2": "",
        },
        "fundamentals_analyst": {
            ...
            "BAM":   "AUM של $925B צומח ב-15%+ שנתית. הכנסות מעמלות יציבות וצפויות, בגלל חוזים ארוכים. יחס תשואה להון (ROE) גבוה מהממוצע בענף.",
            ...
            "5108.TA": "סקטור הביטוח הישראלי — רווחיות יציבה, ROE של 10-12%, יחס Solvency II תקין (175%+). דיבידנדים עקביים — פונדמנטלים בריאים.",
            "AMZN_2": "",
        },
        "risk_manager": {
            ...
            "BAM":   "גיוון נאה מחוץ לטכנולוגיה — קורלציה נמוכה יחסית עם השוק (0.65). תורמת ליציבות התיק הכללית.",
            ...
            "5108.TA": "נכס מט״ח-שקלי הגנתי — מפחית סיכון מט״ח בתיק (רוב הנכסים דולריים). תורם חיובית לגיוון.",
        },
    }
